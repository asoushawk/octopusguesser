...
#TOP_BLUE:
txt_top_blue_nick_store = open("top_blu]e_nick.txt", "w")
...
def showinfo():  # mostrar jogadores e campeoes
    ...
    print(txt_top_blue_nick_store_text_r, "-", txt_top_blue_champion_store_text_r, "Taxa de vitória 1v1:",
          txt_top_blue_1v1wr_champion_month_r_text,"Taxa de Vitorias em lutas", txt_top_blue_tfwr_champion_month_text_r)
    ...
    print(txt_top_blue_1v1wr_champion_month_r_text)
    print(txt_top_blue_win_champion)
    print(txt_top_blue_tfwr_champion_month_text_r)
