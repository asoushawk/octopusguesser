...
try:
    # time azul champions:
    top_blue_champion = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[1]/li[1]/div/div[2]/div[1]/div/div[1]/div[1]/img').get_attribute("alt")
    jg_blue_champion = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[1]/li[2]/div/div[2]/div[1]/div/div/div[1]/img').get_attribute("alt")
    mid_blue_champion = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[1]/li[3]/div/div[2]/div[1]/div/div[1]/div[1]/img').get_attribute("alt")
    adc_blue_champion = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[1]/li[4]/div/div[2]/div[1]/div/div/div[1]/img').get_attribute("alt")
    sup_blue_champion = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[1]/li[5]/div/div[2]/div[1]/div/div/div[1]/img').get_attribute("alt")
...
top_red_champion = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[2]/li[1]/div/div[2]/div[1]/div/div[1]/div[1]/img').get_attribute("alt")
jg_red_champion = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[2]/li[2]/div/div[2]/div[1]/div/div/div[1]/img').get_attribute("alt")
mid_red_champion = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[2]/li[3]/div/div[2]/div[1]/div/div[1]/div[1]/img').get_attribute("alt")
adc_red_champion = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[2]/li[4]/div/div[2]/div[1]/div/div/div[1]/img').get_attribute("alt")
sup_red_champion = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[2]/li[5]/div/div[2]/div[1]/div/div/div[1]/img').get_attribute("alt")
...
# time vermelho nicks:
top_red_nick = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[2]/li[1]/div/div[1]/a')
jg_red_nick = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[2]/li[2]/div/div[1]/a')
mid_red_nick = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[2]/li[3]/div/div[1]/a')
adc_red_nick = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[2]/li[4]/div/div[1]/a')
sup_red_nick = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[2]/li[5]/div/div[1]/a')
...
top_blue_nick = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[1]/li[1]/div/div[1]/a')
jg_blue_nick = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[1]/li[2]/div/div[1]/a')
mid_blue_nick = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[1]/li[3]/div/div[1]/a')
adc_blue_nick = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[1]/li[4]/div/div[1]/a')
sup_blue_nick = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[1]/li[5]/div/div[1]/a')
...
top_blue_win_champion = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[1]/li[1]/div/div[2]/div[1]/div/div[1]/div[2]/div[1]')
jg_blue_win_champion = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[1]/li[2]/div/div[2]/div[1]/div/div[1]/div[2]/div[1]')
mid_blue_win_champion = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[1]/li[3]/div/div[2]/div[1]/div/div[1]/div[2]/div[1]')
adc_blue_win_champion = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[1]/li[4]/div/div[2]/div[1]/div/div[1]/div[2]/div[1]')
sup_blue_win_champion = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[1]/li[5]/div/div[2]/div[1]/div/div[1]/div[2]/div[1]')
#store:
...
top_red_win_champion = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[2]/li[1]/div/div[2]/div[1]/div/div[1]/div[2]/div[1]')
jg_red_win_champion = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[2]/li[2]/div/div[2]/div[1]/div/div[1]/div[2]/div[1]')
mid_red_win_champion = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[2]/li[3]/div/div[2]/div[1]/div/div[1]/div[2]/div[1]')
adc_red_win_champion = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[2]/li[4]/div/div[2]/div[1]/div/div[1]/div[2]/div[1]')
sup_red_win_champion = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[2]/li[5]/div/div[2]/div[1]/div/div[1]/div[2]/div[1]')
...
top_blue_champion_kda = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[1]/li[1]/div/div[2]/div[1]/div/div[1]/div[2]/div[2]/div[1]')
jg_blue_champion_kda = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[1]/li[2]/div/div[2]/div[1]/div/div[1]/div[2]/div[2]/div[1]')
mid_blue_champion_kda = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[1]/li[3]/div/div[2]/div[1]/div/div[1]/div[2]/div[2]/div[1]')
...
jg_blue_mainrole = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[1]/li[2]/div/div[2]/div[3]/div[1]/div[2]/div[2]/span')
mid_blue_mainrole = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[1]/li[3]/div/div[2]/div[3]/div[1]/div[2]/div[2]/span')
adc_blue_mainrole = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[1]/li[4]/div/div[2]/div[3]/div[1]/div[2]/div[2]/span')
sup_blue_mainrole = driver.find_element_by_xpath('//*[@id="liveContent"]/div[1]/ul[1]/li[5]/div/div[2]/div[3]/div[1]/div[2]/div[2]/span')
...
def wukongtesttop():
    ...
    if maybewukong == "Wukong":
        ...
        top_blue_leaguegraph_profile = leaguegraph_main_profile_stats + top_blue_champion.lower() + "/" + "br/" + txt_jg_blue_nick_store_text_r + top_lane
...
try:
    ...
    txt_top_blue_gamesjogados_month = open("top_blue_gamesjogados_month.txt", "w")
    ...
    print("Jogos com", txt_top_blue_champion_store_text_r, "nos últimos 30 dias:", txt_top_blue_gamesjogados_month_text_r)

    # coleta porcentagem de vitoria no mês com campeão
    player_wr_champion_month = driver.find_element_by_xpath('//*[@id="graphDD55"]')
    txt_top_blue_wr_champion_month = open("txt_top_blue_wr_champion_month.txt", "w")
    ...
    txt_top_blue_tfwr_champion_month = open("txt_top_blue_tfwr_champion_month.txt", "w")
    ...
    print("Taxa de Vitória de Team Fights", txt_top_blue_tfwr_champion_month_text_r)


    # taxa de vitoria em 1v1:

    player_1v1wr_champion_month = driver.find_element_by_xpath('//*[@id="graphDD24"]')
    txt_top_blue_1v1wr_champion_month = open("txt_top_blue_1v1wr_champion_month.txt", "w")
    ...
    txt_top_blue_tfp_champion_month = open("txt_top_blue_tfp_champion_month.txt", "w")
...
top_blue_mobalytics_profile = mobalytics_main_profile_stats + txt_top_blue_nick_store_text_r + "/" + "champions?champion=" + top_blue_champion
driver.get(top_blue_mobalytics_profile)
time.sleep(30)
top_blue_champion_alltime_wr = driver.find_element_by_xpath('//*[@id="app-content"]/div[1]/div[4]/div[2]/div/div[3]/div/div[2]/div[2]/div[4]/div/div[3]')
print("Taxa de vitórias com", txt_top_blue_champion_store_text_r ,"total", top_blue_champion_alltime_wr.text)
...
jg_blue_leaguegraph_profile = leaguegraph_main_profile_stats + jg_blue_champion.lower() + "/" + "br/" + txt_jg_blue_nick_store_text_r + jg_lane
...
print("Jogos com", txt_jg_blue_champion_store_text_r, "nos últimos 30 dias:", txt_jg_blue_gamesjogados_month_text_r)
...
print("Taxa de Vitória de Team Fights", txt_jg_blue_tfwr_champion_month_text_r)
...
mobalytics_main_profile_stats = "https://app.mobalytics.gg/lol/profile/br/"
jg_blue_mobalytics_profile = mobalytics_main_profile_stats + txt_jg_blue_nick_store_text_r + "/" + "champions?champion=" + jg_blue_champion
driver.get(jg_blue_mobalytics_profile)
time.sleep(30)
jg_blue_champion_alltime_wr = driver.find_element_by_xpath('//*[@id="app-content"]/div[1]/div[4]/div[2]/div/div[3]/div/div[2]/div[2]/div[4]/div/div[3]')
print("Taxa de vitórias com", txt_jg_blue_champion_store_text_r ,"total", jg_blue_champion_alltime_wr.text)
...
mid_blue_leaguegraph_profile = leaguegraph_main_profile_stats + mid_blue_champion.lower() + "/" + "br/" + txt_mid_blue_nick_store_text_r + mid_lane
driver.get(mid_blue_leaguegraph_profile)
time.sleep(5)
try:
    player_gamesjogados_month = driver.find_element_by_xpath('//*[@id="graphDD54"]')
    txt_mid_blue_gamesjogados_month = open("mid_blue_gamesjogados_month.txt", "w")
    txt_mid_blue_gamesjogados_month.write(player_gamesjogados_month.text)
    txt_mid_blue_gamesjogados_month.close()
    txt_mid_blue_gamesjogados_month_r = open("mid_blue_gamesjogados_month.txt", "r")
    txt_mid_blue_gamesjogados_month_text_r = txt_mid_blue_gamesjogados_month_r.read()
    print("Jogos com", txt_mid_blue_champion_store_text_r, "nos últimos 30 dias:", txt_mid_blue_gamesjogados_month_text_r)

    # coleta porcentagem de vitoria no mês com campeão
    player_wr_champion_month = driver.find_element_by_xpath('//*[@id="graphDD55"]')
    txt_mid_blue_wr_champion_month = open("txt_mid_blue_wr_champion_month.txt", "w")
    txt_mid_blue_wr_champion_month.write(player_wr_champion_month.text)
    txt_mid_blue_wr_champion_month.close()
    txt_mid_blue_wr_champion_month_r = open("txt_mid_blue_wr_champion_month.txt", "r")
    ...
    player_tfwr_champion_month = driver.find_element_by_xpath('//*[@id="graphDD23"]')
    txt_mid_blue_tfwr_champion_month = open("txt_mid_blue_tfwr_champion_month.txt", "w")
    txt_mid_blue_tfwr_champion_month.write(player_tfwr_champion_month.text)
    txt_mid_blue_tfwr_champion_month.close()
    txt_mid_blue_tfwr_champion_month_r = open("txt_mid_blue_tfwr_champion_month.txt", "r")
    txt_mid_blue_tfwr_champion_month_text_r = txt_mid_blue_tfwr_champion_month_r.read()
    print("Taxa de Vitória de Team Fights", txt_mid_blue_tfwr_champion_month_text_r)


    # taxa de vitoria em 1v1:

    player_1v1wr_champion_month = driver.find_element_by_xpath('//*[@id="graphDD24"]')
    txt_mid_blue_1v1wr_champion_month = open("txt_mid_blue_1v1wr_champion_month.txt", "w")
    txt_mid_blue_1v1wr_champion_month.write(player_1v1wr_champion_month.text)
    txt_mid_blue_1v1wr_champion_month.close()
    txt_mid_blue_1v1wr_champion_month_r = open("txt_mid_blue_1v1wr_champion_month.txt", "r")
    ...
    player_tfp_champion_month = driver.find_element_by_xpath('//*[@id="graphDD26"]')
    txt_mid_blue_tfp_champion_month = open("txt_mid_blue_tfp_champion_month.txt", "w")
    txt_mid_blue_tfp_champion_month.write(player_tfp_champion_month.text)
    txt_mid_blue_tfp_champion_month.close()
    txt_mid_blue_tfp_champion_month_r = open("txt_mid_blue_tfp_champion_month.txt", "r")
...
def showinfo():  # mostrar jogadores e campeoes
    ...
    print(txt_top_blue_nick_store_text_r, "-", txt_top_blue_champion_store_text_r, )
    print(txt_jg_blue_nick_store_text_r, "-", txt_jg_blue_champion_store_text_r, )
    print(txt_mid_blue_nick_store_text_r, "-", txt_mid_blue_champion_store_text_r, )
    print(txt_adc_blue_nick_store_text_r, "-", txt_adc_blue_champion_store_text_r, )
    print(txt_sup_blue_nick_store_text_r, "-", txt_sup_blue_champion_store_text_r, )

    print("Jogadores Time Vermelho:")
    print(txt_top_red_nick_store_text_r, "-", txt_top_red_champion_store_text_r, )
    print(txt_jg_red_nick_store_text_r, "-", txt_jg_red_champion_store_text_r, )
    print(txt_mid_red_nick_store_text_r, "-", txt_mid_red_champion_store_text_r, )
    print(txt_adc_red_nick_store_text_r, "-", txt_adc_red_champion_store_text_r, )
    print(txt_sup_red_nick_store_text_r, "-", txt_sup_red_champion_store_text_r, )


showinfo()  # rodando função de mostrar informação
