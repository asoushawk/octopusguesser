...
def colectdata():
    ...
    try: 
        ...
        print("Nome de jogos com o campeão:", txt_adc_red_gamesplayed_champion_r_text)
    except:
        pass
    # SUP leaguegraphs:
...
def toplane():
    ...
    try:
        ...
        print(txt_top_blue_champion_store_text_r)
        ...
        print("Taxa de vitória:", tbwrchampion_month)

        txt_top_red_wr_champion_month_r = open(
            "txt_top_red_wr_champion_month.txt", "r")
        txt_top_red_wr_champion_month_text_r = txt_top_red_wr_champion_month_r.read()
        trwrchampion_month = txt_top_red_wr_champion_month_text_r.strip('%')
        print("Taxa de vitória:", trwrchampion_month)

        tbwrchampion_month_float = float(tbwrchampion_month)
        trwrchampion_month_float = float(trwrchampion_month)

        if trwrchampion_month < tbwrchampion_month:                                                         
            print("Red wins")
            
            twrchampion_month_result = (tbwrchampion_month_float-trwrchampion_month_float)
            print(twrchampion_month_result)
            winner1top = "red"
...
#loads the data
    ...
    #makes the comparison between data
